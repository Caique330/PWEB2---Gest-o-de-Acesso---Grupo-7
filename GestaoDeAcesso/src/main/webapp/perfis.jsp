...
<head>
    <meta charset="UTF-8">
    <title>Gestão de Perfis - TechMaster</title>
    <style>
        ...
        .btn { text-decoration: none; padding: 0.6rem 1.2rem; border-radius: 5px; font-weight: 500; transition: background-color 0.3s ease; }
...
<body>
    ...
    <div class="container">
        <div class="page-header">
            ...
            <a href="${pageContext.request.contextPath}/perfis?action=new" class="btn btn-primary">Novo Perfil</a>
        </div>
                ...
                <c:forEach var="perfil" items="${listaPerfis}">
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <a href="${pageContext.request.contextPath}/perfis?action=edit&id=${perfil.id}" class="btn btn-secondary">Editar</a>
                            
                            <c:if test="${perfil.id != 1}">
                                <a href="${pageContext.request.contextPath}/perfis?action=delete&id=${perfil.id}" 
                                   class="btn btn-danger" 
                                   onclick="return confirm('Tem certeza que deseja excluir ${perfil.nomePerfil}?');">
                                   Excluir
                                </a>
        ...
        <td class="actions">
            ...
            <a href="${pageContext.request.contextPath}/regras?perfilId=${perfil.id}" 
               class="btn btn-info">
               Regras
            </a>
